...
class MyHarness(Harness):
    ...
    def _build_messages(self, text: str):
        ...
        # 任务自适应：MCQ（无 desc）时用选择题专用 system msg + reasoning；其他用标准分类器
        mcq_mode = not self._descriptions
        ...
        mcq_mode = not self._descriptions
        use_reasoning = True  # [DEV-best 变体] 强制全任务开 reasoning；加权最优变体改回 use_reasoning = mcq_mode
        if mcq_mode:
            system_msg = (
